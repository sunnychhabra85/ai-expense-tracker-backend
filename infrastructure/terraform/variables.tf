...
variable "project_name" { type = string default = "finance-platform" }
...
variable "service_names" { type = list(string) default = ["auth-service", "upload-service", "processing-service", "analytics-service", "notification-service"] }
