// =============================================================
// apps/analytics-service/src/common/guards/jwt-auth.guard.ts
// Same pattern as upload-service — validates auth-service JWTs
// =============================================================
...
export class JwtStrategy extends PassportStrategy(Strategy, 'jwt') {
  constructor(config: ConfigService, private readonly db: DatabaseService) {
    super({
      ...
      secretOrKey: config.get<string>('analytics.jwt.accessSecret'),
    });
  }
